        ...
        <script type="text/javascript">
                    ...
                    my: "left left",
                            ...
                            items:'li',
                                    ...
                                    change: function(event, ui) {$("#object").val(ui.item.value); }
            ...
            function check1(){
                                                                                ...
                                                                                absdlon = Math.abs(Math.round(input_form.dlon.value * 1000000));
                                                                                        ...
                                                                                        //Error checks
                                                                                        if (absdlon > (180 * 1000000)) {  alert( ' Degrees Longitude must be in the range of - 180 to 180. ' ); input_form.dlon.value = ' ' ; input_form.mlon.value = ' ' ; }
            ...
            function check2(){
                                                                                       ...
                                                                                       input_form.mlon.value = Math.abs(Math.round(input_form.mlon.value * 1000000) / 1000000); 
                                                                                               ...
                                                                                               //Error checks
                                                                                               if (absmlon > (60 * 1000000))   {  alert( ' Minutes Longitude must be in the range of 0 to 59. ' ); input_form.mlon.value = ' ' ; input_form.slon.value = ' ' ; }
            ...
            function check4(){
                                                                                ...
                                                                                absdlat = Math.abs(Math.round(input_form.dlat.value * 1000000));
                                                                                        ...
                                                                                        //Error checks
                                                                                        if (absdlat > (90 * 1000000)) { alert( ' Degrees Latitude must be in the range of - 90 to 90. ' ); input_form.dlat.value = ' ' ; input_form.dlat.value = ' ' ; input_form.mlat.value = ' ' ; }
            ...
            function check5(){
                                                                                       ...
                                                                                       input_form.mlat.value = Math.abs(Math.round(input_form.mlat.value * 1000000) / 1000000); 
                                                                                               ...
                                                                                               //Error checks
                                                                                               if (absmlat >  (60 * 1000000)) {  alert( ' Minutes Latitude must be in the range of 0 to 59. ' ); input_form.mlat.value = ' ' ; input_form.slat.value = ' ' ; }
                ...
                <div style="margin: 10px;padding: 10px"> 
                    <div id="contents" style="width:100%;align:center">
                        ...
                        <div style="width:50%;float:left"> 
                            ...
                            %>
                            <form class="form-horizontal" name="input_form" action="Store" method="post" onsubmit="return checkForm()">
                                <fieldset>
